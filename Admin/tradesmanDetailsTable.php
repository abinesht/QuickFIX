...
<body>
    ...
    <div class="container" style="background-color: white;">
        <h2 class="mt-4 text-center">Tradesman Details</h2>
    </div>
    ...
    <div class="container">
        <!-- tradesman detail table -->
        <div style="border: 5px double #142f61; padding:10px;">
            <div id="tradesmantable-adminpage" class="table-bg table-responsive">
                <table class="table text-center">
                    <thead>
                        <tr id="tradesmantable-head">
                            <th scope="col">ID</th>
                    ...
                    <tbody>
                        ...
                        $sql = "SELECT * from tradesman limit " . $page_first_result . ',' . $results_per_page;
                        $result = QueryHandler::query($sql);
                        if (!$result) {
                            die('QUERY FAIL!');
                        }
                        ...
                        ?>
                            ...
                            <tr id="tradesmantable-row">
                                <td> <?php echo $row['tradesman_id'] ?></td>
                                <td><?php echo $tradesman->getFirstname() ?></td>
                                <td><?php echo $tradesman->getLastname() ?></td>
                                <td><?php echo $tradesman->getEmail() ?></td>
                                <td><?php echo $tradesman->getPhone_no() ?></td>
                                <td><?php echo $tradesman->getAddress() ?></td>
                                <td><?php echo $tradesman->getReg_date_as_tradesman() ?></td>
                                <td><?php echo $tradesman->getTotal_earnings() ?>.00</td>
        ...
        <nav id="nav" aria-label="Blog Page navigation example" class="my-5">
            <ul class="pagination  justify-content-center">
                ...
                for ($page = 1; $page <= $number_of_page; $page++) {
                    echo ' <li class="page-item"><a class="page-link" href="tradesmanDetailsTable.php?page=' . $page . '">' . $page . ' </a></li>';
                }
                ?>
            </ul>
        </nav>
